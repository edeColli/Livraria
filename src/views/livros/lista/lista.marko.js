...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/nodejs$1.0.0/src/views/livros/lista/lista.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1> Listagem de livros </h1><table id=\"livros\"><tr><td>ID</td><td>Título</td><td>Preço</td><td>Descrição</td><td>Editar</td><td>Remover</td></tr>");
...
marko_template.meta = {
    id: "/nodejs$1.0.0/src/views/livros/lista/lista.marko",
    tags: [
